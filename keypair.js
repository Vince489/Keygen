...
class Keypair {
  ...
  // Convert keypair to a JSON object
  toJSON() {
    return {
  ...
  // Create a Keypair instance from a JSON object
  static fromJSON(json) {
    if (!json.publicKey || !json.privateKey) {
      throw new Error('Invalid keypair JSON object.');
    }
    return new Keypair(json.publicKey, json.privateKey);
  }
}
